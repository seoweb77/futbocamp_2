...
$months = [
    [
        'name' => 'Март 2026',
        'dates' => [
            ['period' => '1-10 марта', 'status' => 'available', 'age' => '7-12 лет', 'places' => '12 мест'],
            ['period' => '18-28 марта', 'status' => 'available', 'age' => '10-15 лет', 'places' => '8 мест']
        ]
    ],
    [
        'name' => 'Апрель 2026',
        'dates' => [
            ['period' => '1-10 апреля', 'status' => 'waiting', 'age' => '7-12 лет', 'places' => '15 мест'],
            ['period' => '18-28 апреля', 'status' => 'available', 'age' => '10-15 лет', 'places' => '10 мест']
        ]
    ],
    [
        'name' => 'Май 2026',
        'dates' => [
            ['period' => '1-10 мая', 'status' => 'available', 'age' => '7-15 лет', 'places' => '20 мест'],
            ['period' => '18-28 мая', 'status' => 'available', 'age' => '7-15 лет', 'places' => '18 мест']
        ]
    ]
];
?>
...
<body>
    <div class="calendar-container">
        ...
        <!-- Заголовок сезона -->
        <header class="season-header spring">
            <div class="season-title">
                <h1><i class="fas fa-seedling"></i> <?php echo $season_name; ?></h1>
                <p class="season-subtitle">Футбольные сборы в весенний период</p>
            </div>
        ...
        <div class="camp-info">
            ...
            <div class="info-card">
                ...
                <h4>Питание</h4>
                <p>3-разовое сбалансированное<br>С учетом спортивных нагрузок</p>
            </div>
