...
$months = [
    [
        'name' => 'Декабрь 2026',
        'dates' => [
            ['period' => '1-10 декабря', 'status' => 'available', 'age' => '7-12 лет', 'places' => '12 мест'],
            ['period' => '18-28 декабря', 'status' => 'available', 'age' => '10-15 лет', 'places' => '8 мест']
        ]
    ],
    [
        'name' => 'Январь 2027',
        'dates' => [
            ['period' => '1-10 января', 'status' => 'waiting', 'age' => '7-12 лет', 'places' => '15 мест'],
            ['period' => '18-28 января', 'status' => 'available', 'age' => '10-15 лет', 'places' => '10 мест']
        ]
    ],
    [
        'name' => 'Февраль 2027',
        'dates' => [
            ['period' => '1-10 февраля', 'status' => 'available', 'age' => '7-15 лет', 'places' => '20 мест'],
            ['period' => '18-28 февраля', 'status' => 'available', 'age' => '7-15 лет', 'places' => '18 мест']
        ]
    ]
];
?>
    ...
    <div class="calendar-container">
        ...
        <header class="season-header summer">
            <div class="season-title">
                ...
                <p class="season-subtitle">Футбольные сборы в зимний период</p>
            </div>
