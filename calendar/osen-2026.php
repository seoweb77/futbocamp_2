...
$months = [
    [
        'name' => 'Сентябрь 2026',
        'dates' => [
            ['period' => '1-10 сентября', 'status' => 'available', 'age' => '7-12 лет', 'places' => '12 мест'],
            ['period' => '18-28 сентября', 'status' => 'available', 'age' => '10-15 лет', 'places' => '8 мест']
        ]
    ],
    [
        'name' => 'Октябрь 2026',
        'dates' => [
            ['period' => '1-10 октября', 'status' => 'waiting', 'age' => '7-12 лет', 'places' => '15 мест'],
            ['period' => '18-28 октября', 'status' => 'available', 'age' => '10-15 лет', 'places' => '10 мест']
        ]
    ],
    [
        'name' => 'Ноябрь 2026',
        'dates' => [
            ['period' => '1-10 ноября', 'status' => 'available', 'age' => '7-15 лет', 'places' => '20 мест'],
            ['period' => '18-28 ноября', 'status' => 'available', 'age' => '7-15 лет', 'places' => '18 мест']
        ]
    ]
];
?>
    ...
    <div class="calendar-container">
        ...
        <header class="season-header summer">
            <div class="season-title">
                ...
                <p class="season-subtitle">Футбольные сборы в осенний период</p>
            </div>
